...
namespace autoTestsProject.Tests.Lecturer.PositiveTests
{
    ...
    public class SubjectTests
    {
        ...
        [TestCase("Нормальный измененный тестовый предмет", "Нормальный тестовый предмет для удаления", "НТПУ")]
        [TestCase("Отредактированный тестовый предмет для изучения БД", "Тестовый предмет для изучения БД для удаления", "ТСБДУ")]
        ...
        [TestCase("Нормальный измененный тестовый предмет")]
        [TestCase("Отредактированный тестовый предмет для изучения БД")]
